...
public final class ProcessCommonJSModulesTest extends CompilerTestCase {
    ...
    protected CompilerPass getProcessor(final Compiler compiler) {
        return new CompilerPass() {
            ...
            public void process(Node externs, Node root) {
                ...
                assertEquals("Last source should be main test script", getFilename() + ".js", testCodeScript.getSourceFileName());
                ProcessCommonJSModules processor = new ProcessCommonJSModules(compiler, new ES6ModuleLoader(ImmutableList.of("foo/bar/"), compiler.getInputsForTesting()), false);
    ...
    public void testWithoutExports() {
        setFilename("test");
        testModules("var name = require('other');" + "name()", "goog.provide('module$test');" + "goog.require('module$other');" + "var name$$module$test = module$other;" + "name$$module$test();");
        setFilename("test/sub");
        ProcessEs6ModulesTest.testModules(this, ImmutableList.of(SourceFile.fromCode(Compiler.joinPathParts("mod", "name.js"), ""), SourceFile.fromCode(Compiler.joinPathParts("test", "sub.js"), "var name = require('mod/name');" + "(function() { name(); })();")), "goog.provide('module$test$sub');" + "goog.require('module$mod$name');" + "var name$$module$test$sub = module$mod$name;" + "(function() { name$$module$test$sub(); })();");
    }

    public void testExports() {
        setFilename("test");
        testModules("var name = require('other');" + "exports.foo = 1;", "goog.provide('module$test');" + "goog.require('module$other');" + "var name$$module$test = module$other;" + "module$test.foo = 1;");
        testModules("var name = require('other');" + "module.exports = function() {};", "goog.provide('module$test');" + "goog.require('module$other');" + "var name$$module$test = module$other;" + "/** @const */ module$test = function () {};");
    }
    ...
    public void testPropertyExports() {
        setFilename("test");
        testModules("exports.one = 1;" + "module.exports.obj = {};" + "module.exports.obj.two = 2;", "goog.provide('module$test');" + "module$test.one = 1;" + "module$test.obj = {};" + "module$test.obj.two = 2;");
    }

    public void testModuleExportsWrittenWithExportsRefs() {
        setFilename("test");
        testModules("exports.one = 1;" + "module.exports = {};", "goog.provide('module$test');" + "var exports$$module$test = module$test;" + "exports$$module$test.one = 1;" + "module$test = {};");
    }

    public void testVarRenaming() {
        setFilename("test");
        testModules("var a = 1, b = 2;" + "(function() { var a; b = 4})()", "goog.provide('module$test');" + "var a$$module$test = 1, b$$module$test = 2;" + "(function() { var a; b$$module$test = 4})();");
    }
    ...
    public void testModuleName() {
        setFilename("foo/bar");
        testModules("var name = require('other');", "goog.provide('module$foo$bar');" + "goog.require('module$other');" + "var name$$module$foo$bar = module$other;");
        ProcessEs6ModulesTest.testModules(this, ImmutableList.of(SourceFile.fromCode(Compiler.joinPathParts("foo", "name.js"), ""), SourceFile.fromCode(Compiler.joinPathParts("foo", "bar.js"), "var name = require('./name');")), "goog.provide('module$foo$bar');" + "goog.require('module$foo$name');" + "var name$$module$foo$bar = module$foo$name;");
    }
    ...
    public void testEs6ObjectShorthand() {
        ...
        setFilename("test");
        testModules(LINE_JOINER.join("function foo() {}", "module.exports = {", "  prop: 'value',", "  foo", "};"), LINE_JOINER.join("goog.provide('module$test');", "function foo$$module$test() {}", "/** @const */ module$test = {", "  /** @const */ prop: 'value',", "  /** @const */ foo", "};"));
