...
public final class CompilerTest extends TestCase {
    ...
    public void testCommonJSMissingRequire() throws Exception {
        ...
        Compiler compiler = initCompilerForCommonJS(inputs, ImmutableList.of("module$gin"));
    ...
    private Function<String, SourceFile> createFileLoader(final List<SourceFile> sourceFiles) {
    ...
    private Compiler initCompilerForCommonJS(List<SourceFile> inputs, List<String> entryPoints) throws Exception {
        CompilerOptions options = new CompilerOptions();
        options.setIdeMode(true);
   ...
   */
    ...
    public void testMalformedFunctionInExterns() throws Exception {
        ...
        new Compiler().compile(ImmutableList.of(SourceFile.fromCode("externs", "function f {}")), ImmutableList.of(SourceFile.fromCode("foo", "")), new CompilerOptions());
    }
   ...
   */
    ...
    public void testIdeModeSkipsOptimizations() {
        ...
        List<SourceFile> inputs = ImmutableList.of(SourceFile.fromCode("testcode", js));
        compiler.compile(EMPTY_EXTERNS, inputs, options);
        // should run these custom passes
        assertTrue(before[0]);
        // but not these
        assertFalse(after[0]);
    }
