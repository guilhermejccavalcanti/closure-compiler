...
public final class CommandLineRunnerTest extends TestCase {
    ...
    public void testIssue601b() {
        args.add("--compilation_level=ADVANCED_OPTIMIZATIONS");
        test("function f() { return '\\v' == 'v'; } window['f'] = f;", "window.f=function(){return'\\v'=='v'}");
    }
    ...
    public void testSideEffectIntegration() {
        args.add("--compilation_level=ADVANCED_OPTIMIZATIONS");
        test("/** @constructor */" + "var Foo = function() {};" + "Foo.prototype.blah = function() {" + "  Foo.bar_(this)" + "};" + "Foo.bar_ = function(f) {" + "  f.x = 5;" + "};" + "var y = new Foo();" + "Foo.bar_({});" + // due to bad side-effect propagation.
        "y.blah();" + "alert(y);", "var a = new function(){}; a.a = 5; alert(a);");
    }
    ...
    public void testExternsLifting2() {
        args.add("--warning_level=VERBOSE");
        test(new String[] { "/** @externs */ function f() {}", "f(3);" }, new String[] { "f(3);" }, TypeCheck.WRONG_ARGUMENT_COUNT);
    }
    ...
    public void testSourceSortingOn() {
        test(new String[] { "goog.require('beer');", "goog.provide('beer');" }, new String[] { "var beer = {};", "" });
    }

    public void testSourceSortingOn2() {
        test(new String[] { "goog.provide('a');", "goog.require('a');\n" + "var COMPILED = false;" }, new String[] { "var a={};", "var COMPILED=!1" });
    }
    ...
    public void testSourceSortingCircularDeps1() {
        args.add("--dependency_mode=LOOSE");
        args.add("--language_in=ECMASCRIPT5");
        test(new String[] { "goog.provide('gin'); goog.require('tonic'); var gin = {};", "goog.provide('tonic'); goog.require('gin'); var tonic = {};", "goog.require('gin'); goog.require('tonic');" }, JSModule.CIRCULAR_DEPENDENCY_ERROR);
    }

    public void testSourceSortingCircularDeps2() {
        args.add("--dependency_mode=LOOSE");
        args.add("--language_in=ECMASCRIPT5");
        test(new String[] { "goog.provide('roses.lime.juice');", "goog.provide('gin'); goog.require('tonic'); var gin = {};", "goog.provide('tonic'); goog.require('gin'); var tonic = {};", "goog.require('gin'); goog.require('tonic');", "goog.provide('gimlet'); goog.require('gin'); goog.require('roses.lime.juice');" }, JSModule.CIRCULAR_DEPENDENCY_ERROR);
    }

    public void testSourcePruningOn1() {
        args.add("--dependency_mode=LOOSE");
        args.add("--language_in=ECMASCRIPT5");
        test(new String[] { "goog.require('beer');", "goog.provide('beer');", "goog.provide('scotch'); var x = 3;" }, new String[] { "var beer = {};", "" });
    }
    ...
    public void testSourcePruningOn3() {
        ...
        test(new String[] { "goog.provide('guinness');\ngoog.require('beer');", "goog.provide('beer');", "goog.provide('scotch'); var x = 3;" }, new String[] { "var scotch = {}, x = 3;" });
    }
    ...
    public void testSourcePruningOn6() {
        args.add("--entry_point=goog:scotch");
        test(new String[] { "goog.require('beer');", "goog.provide('beer');", "goog.provide('scotch'); var x = 3;" }, new String[] { "var beer = {};", "", "var scotch = {}, x = 3;" });
    }

    public void testSourcePruningOn7() {
        args.add("--dependency_mode=LOOSE");
        test(new String[] { "var COMPILED = false;" }, new String[] { "var COMPILED = !1;" });
    }
    ...
    public void testModuleEntryPoint() throws Exception {
        ...
        test(new String[] { "goog.provide('a');", "goog.provide('b');" }, // module (m1).
        new String[] { "", "var a = {};" });
    }

    public void testNoCompile() {
        args.add("--warning_level=VERBOSE");
        test(new String[] { "/** @nocompile */\n" + "goog.provide('x');\n" + "var dupeVar;", "var dupeVar;" }, new String[] { "var dupeVar;" });
    }
    ...
    public void testForwardDeclareDroppedTypes() {
        args.add("--dependency_mode=LOOSE");
        args.add("--warning_level=VERBOSE");
        test(new String[] { "goog.require('beer');", "goog.provide('beer'); /** @param {Scotch} x */ function f(x) {}", "goog.provide('Scotch'); var x = 3;" }, new String[] { "var beer = {}; function f(a) {}", "" });
        test(new String[] { "goog.require('beer');", "goog.provide('beer'); /** @param {Scotch} x */ function f(x) {}" }, new String[] { "var beer = {}; function f(a) {}", "" }, RhinoErrorReporter.TYPE_PARSE_ERROR);
    }
    ...
    public void testSourceMapLocationsTranslations2() {
        ...
        testSame("var x = 3;");
        List<LocationMapping> mappings = lastCompiler.getOptions().sourceMapLocationMappings;
        assertThat(ImmutableSet.copyOf(mappings).toString()).isEqualTo(ImmutableSet.of(new LocationMapping("foo/", "http://bar"), new LocationMapping("xxx/", "http://yyy")).toString());
    }
    ...
    public void testChainModuleManifest() throws Exception {
        ...
        assertThat(builder.toString()).isEqualTo("{m0}\n" + "i0\n" + "\n" + "{m1:m0}\n" + "i1\n" + "\n" + "{m2:m1}\n" + "i2\n" + "\n" + "{m3:m2}\n" + "i3\n");
    }
    ...
    public void testMissingReturnCheckOnWithVerbose() {
        args.add("--warning_level=VERBOSE");
        test("/** @return {number} */ function f() {f()} f();", CheckMissingReturn.MISSING_RETURN_STATEMENT);
    }
    ...
    public void testGenerateExports() {
        ...
        test("/** @export */ foo.prototype.x = function() {};", "foo.prototype.x=function(){};" + "goog.exportProperty(foo.prototype,\"x\",foo.prototype.x);");
    }
    ...
    public void testNoSrCFilesWithManifest() throws IOException {
        ...
        assertThat("Bad --js flag. " + "Manifest files cannot be generated when the input is from stdin.").isEqualTo(expectedMessage);
    }
   ...
   */
    public void testProcessCJSWithClosureRequires() {
        ...
        test(new String[] { "/** @provideGoog */\n" + "/** @const */ var goog = goog || {};\n" + "var COMPILED = false;\n" + "goog.provide = function (arg) {};\n" + "goog.require = function (arg) {};", "goog.provide('goog.array');", "goog.require('goog.array');" + "function Baz() {}" + "Baz.prototype = {" + "  baz: function() {" + "    return goog.array.last(['asdf','asd','baz']);" + "  }," + "  bar: function () {" + "    return 4 + 4;" + "  }" + "};" + "module.exports = Baz;", "var Baz = require('./Baz');" + "var baz = new Baz();" + "console.log(baz.baz());" + "console.log(baz.bar());" }, new String[] { "var goog=goog||{},COMPILED=!1;" + "goog.provide=function(a){};goog.require=function(a){};", "goog.array={};", "function Baz$$module$Baz(){}" + "Baz$$module$Baz.prototype={" + "  baz:function(){return goog.array.last(['asdf','asd','baz'])}," + "  bar:function(){return 8}" + "};" + "var module$Baz=Baz$$module$Baz;", "var module$app={}," + "    Baz$$module$app=Baz$$module$Baz," + "    baz$$module$app=new Baz$$module$app;" + "console.log(baz$$module$app.baz());" + "console.log(baz$$module$app.bar())" });
    }
   ...
   */
    public void testProcessCJSWithClosureRequires2() {
        ...
        setFilename(2, "Baz.js");
        setFilename(3, "app.js");
        test(new String[] { "/** @provideGoog */" + "/** @const */ var goog = goog || {};" + "var COMPILED = false;" + "goog.provide = function (arg) {};" + "goog.require = function (arg) {};", "goog.provide('goog.array');", "goog.require('goog.array');" + "function Baz() {}" + "Baz.prototype = {" + "  baz: function() {" + "    return goog.array.last(['asdf','asd','baz']);" + "  }," + "  bar: function () {" + "    return 4 + 4;" + "  }" + "};" + "module.exports = Baz;", "var Baz = require('./Baz');" + "var baz = new Baz();" + "console.log(baz.baz());" + "console.log(baz.bar());" }, new String[] { "var goog=goog||{},COMPILED=!1;" + "goog.provide=function(a){};goog.require=function(a){};", "goog.array={};", "function Baz$$module$Baz(){}" + "Baz$$module$Baz.prototype={" + "baz:function(){return goog.array.last([\"asdf\",\"asd\",\"baz\"])}," + "bar:function(){return 8}" + "};" + "var module$Baz=Baz$$module$Baz;", "var module$app={}," + "Baz$$module$app=Baz$$module$Baz," + "baz$$module$app=new Baz$$module$app;" + "console.log(baz$$module$app.baz());" + "console.log(baz$$module$app.bar());" });
    }
    ...
    public void testProcessCJSWithES6Export() {
        ...
        test(new String[] { "export default class Foo {" + "  bar() { console.log('bar'); }" + "}", "var FooBar = require('./foo');" + "var baz = new FooBar.default();" + "console.log(baz.bar());" }, new String[] { "var module$foo={}," + "Foo$$module$foo=function(){};" + "Foo$$module$foo.prototype.bar=function(){console.log(\"bar\")};" + "module$foo.default=Foo$$module$foo;", "var module$app={}," + "FooBar$$module$app=module$foo," + "baz$$module$app=new FooBar$$module$app.default();" + "console.log(baz$$module$app.bar());" });
    }
    ...
    public void testES6ImportOfCJS() {
        ...
        setFilename(0, "foo.js");
        setFilename(1, "app.js");
        test(new String[] { "/** @constructor */ function Foo () {}" + "Foo.prototype.bar = function() { console.log('bar'); };" + "module.exports = Foo;", "import * as FooBar from './foo';" + "var baz = new FooBar();" + "console.log(baz.bar());" }, new String[] { "function Foo$$module$foo(){}" + "Foo$$module$foo.prototype.bar=function(){console.log(\"bar\")};" + "var module$foo=Foo$$module$foo;", "var module$app={}," + "baz$$module$app$$module$app=new Foo$$module$foo();" + "console.log(baz$$module$app$$module$app.bar());" });
    }
   ...
   */
    private void compileFiles(String expectedOutput, FlagEntry<JsSourceType>... entries) throws FlagUsageException {
   ...
   */
    private Compiler compile(String[] original) {
        ...
        runner.enableTestMode(Suppliers.ofInstance(externs), inputsSupplier, modulesSupplier, new Function<Integer, Boolean>() {
